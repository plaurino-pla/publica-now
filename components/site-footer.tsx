      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <div>
            <Link href="/" className="inline-flex items-center space-x-3 mb-4">
              ...
              <div className="flex flex-col">
                <span className="text-xl font-bold text-[#FAFAFA]">publica.now</span>
                <span className="text-xs text-white/40 uppercase tracking-wide">by publica.la</span>
              </div>
            </Link>
          ...
          <div className="flex gap-16">
            <div>
              <h4 className="text-sm font-semibold uppercase tracking-wide text-white/40 mb-3">Product</h4>
              <ul className="space-y-2">
                <li><Link href="/creators" className="text-white/60 hover:text-white transition-colors text-sm">Discover</Link></li>
            ...
            <div>
              <h4 className="text-sm font-semibold uppercase tracking-wide text-white/40 mb-3">Legal</h4>
              <ul className="space-y-2">
