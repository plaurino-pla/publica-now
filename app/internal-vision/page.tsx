        ...
        <Container className="max-w-6xl">
          <div className="bg-white rounded-2xl shadow-xl p-8 md:p-12">
            ...
            <div className="prose prose-lg max-w-none">
              ...
              <section className="mb-12">
                ...
                <div className="space-y-4">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h3 className="text-lg font-semibold text-gray-900">Seamless creation</h3>
                      <p className="text-gray-700">Creators write in a simple editor (like Substack/Medium).</p>
                    </div>
                  </div>
                  <div className="flex items-start space-x-4">
                    <div className="w-6 h-6 bg-blue-600 rounded-full flex items-center justify-center text-white font-bold text-sm flex-shrink-0 mt-1">
                    ...
                    <div>
                      <h3 className="text-lg font-semibold text-gray-900">Invisible transformation</h3>
                      <p className="text-gray-700">Content is auto-converted into professional formats (EPUB, audio) using Publica.la's backend.</p>
                    </div>
                  </div>
                  <div className="flex items-start space-x-4">
                    <div className="w-6 h-6 bg-blue-600 rounded-full flex items-center justify-center text-white font-bold text-sm flex-shrink-0 mt-1">
                    ...
                    <div>
                      <h3 className="text-lg font-semibold text-gray-900">Flexible monetization</h3>
                      <p className="text-gray-700">Creators choose subscription plans, one-time sales, or free previews.</p>
                    </div>
                  </div>
                  <div className="flex items-start space-x-4">
                    <div className="w-6 h-6 bg-blue-600 rounded-full flex items-center justify-center text-white font-bold text-sm flex-shrink-0 mt-1">
                    ...
                    <div>
                      <h3 className="text-lg font-semibold text-gray-900">Audience-first experiences</h3>
                      <p className="text-gray-700">Users access creator pages hosted on Publica.la infra, subscribe, and consume content.</p>
                    </div>
                  </div>
                  <div className="flex items-start space-x-4">
                    <div className="w-6 h-6 bg-blue-600 rounded-full flex items-center justify-center text-white font-bold text-sm flex-shrink-0 mt-1">
                    ...
                    <div>
                      <h3 className="text-lg font-semibold text-gray-900">Trusted payments</h3>
                      <p className="text-gray-700">All transactions are powered by Publica.la's payments system, with global reach and security.</p>
                    </div>
                  </div>
                </div>
              </section>
              ...
              <section className="mb-12">
                <h2 className="text-3xl font-bold text-gray-900 mb-6">Strategic Roadmap – Publica.now</h2>
                
                <div className="space-y-8">
                  <div className="border-l-4 border-green-600 pl-6">
                    <div className="mb-4">
                      <h3 className="text-2xl font-bold text-gray-900 mb-2">Phase 1 – Foundation (MVP)</h3>
                      <p className="text-gray-600 font-medium">Objective: Deliver a usable, end-to-end flow for creators to publish and monetize.</p>
                    </div>
                  ...
                  <div className="border-l-4 border-yellow-600 pl-6">
                    <div className="mb-4">
                      <h3 className="text-2xl font-bold text-gray-900 mb-2">Phase 2 – Engagement & Growth</h3>
                      <p className="text-gray-600 font-medium">Objective: Expand monetization options and build audience loyalty.</p>
                    </div>
                    <ul className="text-gray-700 space-y-2 mb-4">
              ...
              <section className="mb-12">
                <h2 className="text-3xl font-bold text-gray-900 mb-6">Logical Dependency Chain</h2>
                <div className="space-y-4">
                  <div className="p-4 bg-gray-50 rounded-lg">
                    <h3 className="font-semibold text-gray-900 mb-2">Core flow:</h3>
                    <p className="text-gray-700">text editor → publish → paywall → subscription → payout</p>
                  </div>
                  <div className="p-4 bg-gray-50 rounded-lg">
                    <h3 className="font-semibold text-gray-900 mb-2">Content transformation & delivery:</h3>
                    <p className="text-gray-700">invisible EPUB + audiobook conversion</p>
                  </div>
                  <div className="p-4 bg-gray-50 rounded-lg">
                    <h3 className="font-semibold text-gray-900 mb-2">Monetization expansion:</h3>
                    <p className="text-gray-700">tiers, previews, bundles</p>
                  </div>
                  <div className="p-4 bg-gray-50 rounded-lg">
                    <h3 className="font-semibold text-gray-900 mb-2">Creator growth:</h3>
                    <p className="text-gray-700">analytics, marketing, customization</p>
                  </div>
                  <div className="p-4 bg-gray-50 rounded-lg">
                    <h3 className="font-semibold text-gray-900 mb-2">Intelligence & integrations:</h3>
                    <p className="text-gray-700">AI insights, external APIs, mobile app</p>
                  </div>
                </div>
              </section>

              <section className="mb-12">
                <h2 className="text-3xl font-bold text-gray-900 mb-6">Risks & Mitigations</h2>
                <div className="grid md:grid-cols-2 gap-6">
                  <div className="p-6 border border-red-200 rounded-xl bg-red-50">
                    <h3 className="text-lg font-semibold text-red-900 mb-3">Scope creep</h3>
                    <p className="text-red-800">Avoid overbuilding; stick to atomic, testable features.</p>
                  </div>
              ...
              <section className="mb-12">
                <h2 className="text-3xl font-bold text-gray-900 mb-6">Deliverables Breakdown – Publica.now</h2>
                
                <div className="space-y-8">
                  <div className="border-l-4 border-green-600 pl-6">
                    <h3 className="text-2xl font-bold text-gray-900 mb-4">Phase 1 – Foundation (MVP)</h3>
                    <p className="text-gray-600 font-medium mb-4">Goal: End-to-end flow: creator signs up → writes → publishes → gets paid.</p>
                    
                    <div className="space-y-6">
                      <div>
                        <h4 className="text-lg font-semibold text-gray-900 mb-2">Authentication & Accounts</h4>
                      ...
                      <div>
                        <h4 className="text-lg font-semibold text-gray-900 mb-2">Text Editor (Creator Tool)</h4>
                        <ul className="text-gray-700 space-y-1 ml-4">
                      ...
                      <div>
                        <h4 className="text-lg font-semibold text-gray-900 mb-2">Publishing & Conversion</h4>
                        <ul className="text-gray-700 space-y-1 ml-4">
                      ...
                      <div>
                        <h4 className="text-lg font-semibold text-gray-900 mb-2">Creator Page (Auto-Generated Storefront)</h4>
                        <ul className="text-gray-700 space-y-1 ml-4">
                      ...
                      <div>
                        <h4 className="text-lg font-semibold text-gray-900 mb-2">Monetization (Payments Infra)</h4>
                        <ul className="text-gray-700 space-y-1 ml-4">
                      ...
                      <div>
                        <h4 className="text-lg font-semibold text-gray-900 mb-2">Reader Experience</h4>
                        <ul className="text-gray-700 space-y-1 ml-4">
                  ...
                  <div className="border-l-4 border-yellow-600 pl-6">
                    <h3 className="text-2xl font-bold text-gray-900 mb-4">Phase 2 – Engagement & Growth</h3>
                    <p className="text-gray-600 font-medium mb-4">Goal: Add monetization flexibility, audience engagement, and analytics.</p>
                    
                    <div className="space-y-6">
                      <div>
                        <h4 className="text-lg font-semibold text-gray-900 mb-2">Audio Transformation</h4>
                        <ul className="text-gray-700 space-y-1 ml-4">
                      ...
                      <div>
                        <h4 className="text-lg font-semibold text-gray-900 mb-2">Subscription Tiers & Controls</h4>
                        <ul className="text-gray-700 space-y-1 ml-4">
                      ...
                      <div>
                        <h4 className="text-lg font-semibold text-gray-900 mb-2">Analytics Dashboard (Creator)</h4>
                        <ul className="text-gray-700 space-y-1 ml-4">
                      ...
                      <div>
                        <h4 className="text-lg font-semibold text-gray-900 mb-2">Enhanced Creator Page Customization</h4>
                        <ul className="text-gray-700 space-y-1 ml-4">
                  ...
                  <div className="border-l-4 border-blue-600 pl-6">
                    ...
                    <div className="space-y-6">
                      ...
                      <div>
                        <h4 className="text-lg font-semibold text-gray-900 mb-2">Marketing & Growth Tools</h4>
                        <ul className="text-gray-700 space-y-1 ml-4">
                      ...
                      <div>
                        <h4 className="text-lg font-semibold text-gray-900 mb-2">API & Integration Layer</h4>
                        <ul className="text-gray-700 space-y-1 ml-4">
                      ...
                      <div>
                        <h4 className="text-lg font-semibold text-gray-900 mb-2">Mobile App (Creator + Reader)</h4>
                        <ul className="text-gray-700 space-y-1 ml-4">
              ...
              <section className="mb-12">
                <h2 className="text-3xl font-bold text-gray-900 mb-6">Logical Order of Development (Dependencies)</h2>
                <div className="space-y-4">
                  <div className="p-4 bg-gray-50 rounded-lg">
                    <h3 className="font-semibold text-gray-900 mb-2">Phase 1 foundation:</h3>
                    <p className="text-gray-700">auth, editor, publish, paywall, checkout</p>
                  </div>
                  <div className="p-4 bg-gray-50 rounded-lg">
                    <h3 className="font-semibold text-gray-900 mb-2">Phase 2 expansion:</h3>
                    <p className="text-gray-700">audio, tiers, analytics, customization</p>
                  </div>
                  <div className="p-4 bg-gray-50 rounded-lg">
                    <h3 className="font-semibold text-gray-900 mb-2">Phase 3 growth tools:</h3>
                    <p className="text-gray-700">AI, APIs, mobile app, marketing</p>
                  </div>
                </div>
              </section>

              <section className="mb-12">
                <h2 className="text-3xl font-bold text-gray-900 mb-6">Atomic Sprint Examples (MVP Phase)</h2>
                <div className="grid md:grid-cols-2 gap-6">
                  <div className="p-6 bg-gray-50 rounded-xl">
                    <h3 className="text-lg font-semibold text-gray-900 mb-3">Sprint 1: Auth + roles + basic text editor</h3>
                    <p className="text-gray-700 text-sm">Foundation for user management and content creation</p>
                  </div>
                  <div className="p-6 bg-gray-50 rounded-xl">
                    <h3 className="text-lg font-semibold text-gray-900 mb-3">Sprint 2: Publish pipeline (save → EPUB)</h3>
                    <p className="text-gray-700 text-sm">Core content transformation and storage</p>
                  </div>
                  <div className="p-6 bg-gray-50 rounded-xl">
                    <h3 className="text-lg font-semibold text-gray-900 mb-3">Sprint 3: Creator page auto-generation + content listing</h3>
                    <p className="text-gray-700 text-sm">Public-facing creator presence</p>
                  </div>
                  <div className="p-6 bg-gray-50 rounded-xl">
                    <h3 className="text-lg font-semibold text-gray-900 mb-3">Sprint 4: Payments integration (checkout, payout)</h3>
                    <p className="text-gray-700 text-sm">Monetization infrastructure</p>
                  </div>
                  <div className="p-6 bg-gray-50 rounded-xl">
                    <h3 className="text-lg font-semibold text-gray-900 mb-3">Sprint 5: Reader experience (web reader + lock/unlock)</h3>
                    <p className="text-gray-700 text-sm">End-user content consumption</p>
                  </div>
                </div>
              </section>
