        ...
        <Container className="max-w-4xl">
          <div className="bg-white rounded-2xl shadow-xl p-8 md:p-12">
            ...
            <div className="prose prose-lg max-w-none">
              ...
              <section className="mb-12">
                <h2 className="text-3xl font-bold text-gray-900 mb-6">Strategic Roadmap</h2>
                
                <div className="space-y-8">
                  <div className="border-l-4 border-green-600 pl-6">
                    <div className="mb-4">
                      <h3 className="text-2xl font-bold text-gray-900 mb-2">Phase 1 – Instant Publishing (MVP)</h3>
                      <p className="text-gray-600 font-medium">Foundation: something usable, visible, and fast to market</p>
                    </div>
                  ...
                  <div className="border-l-4 border-yellow-600 pl-6">
                    <div className="mb-4">
                      ...
                      <p className="text-gray-600 font-medium">Expand monetization options and deepen creator–audience connections</p>
                    </div>
                    <ul className="text-gray-700 space-y-2 mb-4">
              ...
              <section className="mb-12">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div className="p-6 bg-gray-50 rounded-xl">
                    <h3 className="text-xl font-semibold text-gray-900 mb-3">Creator Experience</h3>
                  ...
                  <div className="p-6 bg-gray-50 rounded-xl">
                    <h3 className="text-xl font-semibold text-gray-900 mb-3">Platform Performance</h3>
                    <ul className="text-gray-700 space-y-2">
              ...
              <section className="mb-12">
                <h2 className="text-3xl font-bold text-gray-900 mb-6">Core Philosophy</h2>
                <div className="bg-gradient-to-r from-purple-50 to-pink-50 p-8 rounded-xl">
                  <div className="text-center">
                    ...
                    <div className="inline-flex items-center space-x-2 bg-white px-4 py-2 rounded-full shadow-sm">
                      ...
                      <span className="font-semibold text-gray-900">Instant Publishing</span>
                    </div>
                  </div>
                </div>
              </section>
              ...
              <section className="mb-12">
                ...
                <div className="space-y-6">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h3 className="text-xl font-semibold text-gray-900 mb-2">Speed First</h3>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h3 className="text-xl font-semibold text-gray-900 mb-2">Simple & Transparent Pricing</h3>
                      <p className="text-gray-700">
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h3 className="text-xl font-semibold text-gray-900 mb-2">Professional Infrastructure</h3>
                      <p className="text-gray-700">
