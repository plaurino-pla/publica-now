    ...
    <div className="min-h-screen bg-white">
      ...
      <PageSection background="muted">
        <Container className="text-center">
          ...
          <Button asChild size="lg" className="text-lg px-8 py-4 bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 shadow-lg hover:shadow-xl transition-all duration-300"><Link href="/dashboard/new">Get Started Now</Link></Button>
        </Container>
      </PageSection>
      ...
      <PageSection background="white">
        <Container>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center mb-20"><div className="order-2 md:order-1"><div className="flex items-center mb-6"><div className="w-16 h-16 bg-blue-600 rounded-full flex items-center justify-center text-white text-2xl font-bold mr-6">1</div><h3 className="text-3xl font-bold text-gray-900">Write & Create</h3></div><p className="text-lg text-gray-600 mb-6">Start with our intuitive, Substack-style editor. Write your content with rich formatting, add images, and organize your thoughts. Everything saves automatically as you work.</p><ul className="text-gray-600 space-y-3"><li className="flex items-center"><span className="w-2 h-2 bg-blue-600 rounded-full mr-3"></span>Rich text editor with Markdown support</li><li className="flex items-center"><span className="w-2 h-2 bg-blue-600 rounded-full mr-3"></span>Real-time preview and formatting</li><li className="flex items-center"><span className="w-2 h-2 bg-blue-600 rounded-full mr-3"></span>Automatic draft saving</li><li className="flex items-center"><span className="w-2 h-2 bg-blue-600 rounded-full mr-3"></span>Cover image and tag management</li></ul></div><div className="order-1 md:order-2 text-center"><div className="w-80 h-80 bg-gradient-to-br from-blue-100 to-indigo-100 rounded-3xl flex items-center justify-center mx-auto shadow-lg"><span className="text-8xl">✍️</span></div></div></div>
        ...
        <Container>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              <div key={f.title} className="text-center p-6"><div className="w-16 h-16 bg-blue-100 rounded-2xl flex items-center justify-center mx-auto mb-4"><span className="text-2xl">{f.icon}</span></div><h3 className="text-xl font-bold text-gray-900 mb-3">{f.title}</h3><p className="text-gray-600">{f.desc}</p></div>
            ))}
          </div>
        </Container>
      </PageSection>
      ...
      <PageSection background="brand">
        <Container className="text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Button asChild variant="outline" size="lg" className="text-lg px-8 py-4 border-2 border-white text-white hover:bg-white hover:text-blue-600 transition-all duration-300"><Link href="/features">View Features</Link></Button>
          </div>
        </Container>
      </PageSection>
    </div>
