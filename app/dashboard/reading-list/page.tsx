      ...
      <div className="min-h-screen bg-surface-0 py-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="mt-4 text-white/50">Loading your reading list...</p>
          </div>
        </div>
      </div>
    )
          ...
          <PageSection>
            ...
            {error ? (
              <div className="text-center py-12">
                ...
                <h3 className="text-lg font-medium text-[#FAFAFA] mb-2">Failed to load reading list</h3>
              ...
              <div className="text-center py-12">
                ...
                <h3 className="text-lg font-medium text-[#FAFAFA] mb-2">Your reading list is empty</h3>
                <p className="text-white/50 mb-6">Start exploring content and save articles to read them later.</p>
              ...
              <div className="space-y-4">
                ...
                <div className="grid gap-4">
                  {readingList.map((item) => (
                    <Card key={item.id} className="hover:border-white/[0.12] transition-shadow">
                        ...
                        <div className="flex items-start justify-between">
                          ...
                          <div className="ml-4 flex-shrink-0">
                            <div className="w-10 h-10 bg-brand-500/10 rounded-full flex items-center justify-center">
                              <Bookmark className="w-5 h-5 text-brand-400 fill-current" />
                            </div>
                          </div>
                        </div>
                      </CardContent>
